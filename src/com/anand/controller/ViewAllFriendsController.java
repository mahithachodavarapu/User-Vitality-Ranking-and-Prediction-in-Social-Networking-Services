...
public class ViewAllFriendsController extends AbstractController {
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
		...
		return new ModelAndView("view-friends","userList",
				searchFriendsService.getMyFriendProfile(path, accountDto.getEmail()));
