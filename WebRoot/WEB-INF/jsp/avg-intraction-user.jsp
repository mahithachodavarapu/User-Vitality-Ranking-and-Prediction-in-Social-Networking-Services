				...
				<div class="row">
					<div class="col-xs-12">
						...
						<form class="form-inline" action="dashboard.htm">
							<input type="hidden" name="page" value="avg-intraction-user">
						...
						<button type="button" class="btn btn-warning">
							<span class="glyphicon glyphicon-record"></span> Avg interaction for user
						</button>
...
<td class="view-message text-right">
										<span class="glyphicon glyphicon-dashboard"></span> Avg
									</td>
								</tr>
							</thead>
							<tbody>
