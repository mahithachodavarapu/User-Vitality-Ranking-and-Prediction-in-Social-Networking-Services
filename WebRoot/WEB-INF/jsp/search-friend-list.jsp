...
<jsp:include page="profile.jsp"></jsp:include>
			...
			<b class="list-group-item active"> <span
				...
				class="glyphicon glyphicon-user"></span> Search result </b>
...
for(AccountDto profile:userList){
 %>
			 <span class="glyphicon"><img
				...
				<a href="<%=profile.getUrl()%>" class="btn btn-default btn-sm" style="margin: 2px;"><%=profile.getButtonLevel()%></a> 
					<hr/>
