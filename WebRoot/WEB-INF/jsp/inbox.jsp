                            ...
                            if("0".equals(dto.getStatus())){
                             %>
                              <tr class="unread">
                                  ...
                                  <td class="view-message dont-show"> <a href="read-message.htm?mid=<%=key%>"><%=dto.getFromEmail()%> </a> </td>
                                  <td class="view-message">
                                  <a href="read-message.htm?mid=<%=key%>">
                                  <%=dto.getSubject()%></a></td>
                                  <td class="view-message inbox-small-cells"></td>
                                  <td class="view-message text-right"><%=dto.getPostDate()%></td>
                              </tr>
