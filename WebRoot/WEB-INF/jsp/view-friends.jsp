...
<html lang="en">
			...
			<div class="col-sm-6"
				...
				<div class="list-group">
					<b class="list-group-item active"> <span
						class="glyphicon glyphicon-user"></span> Your friend list </b>


					<%
						AccountDto ss = new AccountDto();
						List<AccountDto> userList = (List<AccountDto>) request
 ...
 %> <span class="glyphicon"><img
								src="images/<%=profile.getPicture()%>"
								class="girl img-responsive img-thumbnail"
								style="max-width: 100px;" /> </span> <label>
							<span style="color: black;"> <%=profile.getFullName()%></span>
							<br />
							<%=profile.getAddress()%>
						</label> <br /> <a href="#" class="btn btn-default btn-sm"
						style="margin: 2px;">Your friend</a>
						<hr /> <%
 	}
 %> </b>
					<%
					...
					<b class="list-group-item" style="color: red;"> <span
						class="glyphicon glyphicon-warning-sign"></span> no friend</b>
					<%
						}
					%>
